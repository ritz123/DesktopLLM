...
export default function App() {
  ...
  async function send(event: FormEvent) {
    ...
    await window.desktopLLM.sendChat({ id: activeId, provider, model, messages: [...activeMessages, message].map(({ role, content }) => ({ role, content })), systemPrompt, temperature, attachments });
  }
  ...
  return <main className={`app-shell ${inspectorOpen ? "inspector-open" : ""}`}>
